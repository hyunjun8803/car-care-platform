...
import { Wrench, X, Plus, Calendar, DollarSign, MapPin } from "lucide-react";

import { MaintenanceFormData } from "@/lib/api-client";

interface AddMaintenanceModalProps {
  isOpen: boolean;
  onClose: () => void;
  onAddMaintenance: (maintenanceData: MaintenanceFormData) => void;
  carId: string;
  carName: string;
}
        ...
        <CardHeader className="pb-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <CardTitle className="text-xl">정비 기록 추가</CardTitle>
                <CardDescription>
                  {carName}의 정비 기록을 추가하세요
                </CardDescription>
              </div>
            </div>
